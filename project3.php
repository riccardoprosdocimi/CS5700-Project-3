...
<h2>Project 3: Raw Sockets</h2>
<p>
    
  <b>The final version of the project is due at 11:59pm on November 9, 2022.</b>
...
your program against pages hosted by me or Khoury College</b>. When you are testing your program, you will almost
...
./rawhttpget http://david.choffnes.com/classes/cs5700f22/project3.php
</p><p>
This would create a file named <i>project3.php</i> in the current directory containing the
...
<h2>Turning off offloading</h2>
<p>You should run the following command on your Ubuntu OS:
<pre> % ethtool -K &lt;interface name&gt; gro off</pre>
where "&lt;interface name&gt;" is the name of the Internet-connected networking interface on your VM. 
This is often "eth0" but it could have other names. You can find the list of interfaces on your VM 
by running:
<pre>% ifconfig</pre>
Note that turning off "gro" (generic-receive-offload) prevents the NIC from taking care of various TCP and IP 
features on your behalf. If you don't turn this off, you'll see weird things like invalid checksums.
</p>
<h2>Debugging</h2>
...
When turning in your project, you and your partner(s) must <a href="https://help.gradescope.com/article/m5qz2xsnjy-student-add-group-members">create a group</a> 
on Gradescope. 
...
<li>A plain-text (no Word or PDF) README.md file. In this file, you should briefly describe your high-level
...
Your README.md, Makefile, source code, external libraries, etc. should all be placed in a directory and you should make a Zip file from them. 
...
<b>Note that there is no autograder for this assignment.</b> 
Since raw sockets require root privileges, we are not able to deploy an autograder on Gradescope for this. 
We will, however, explore creating an autograder that checks to make sure all files are in place and 
that your code runs (up until it tries to create a raw socket).
</p>
<p>
<h2>Grading</h2>
...
6.33 points will be awarded for each of the three protocols you must implement, i.e. 6.33 points for HTTP,
6.33 ponts for TCP, and 6.33 points for IP. 1 point will be deducted for poor documentation. Essentially,
6.33 points should be easy to earn; the other 12.67 are the challenge. 
</p><p>
<h2>Extra Credit</h2>
...
implemented Ethernet functionality, and any additional challenges your faced (e.g. ARP).
 ...
 <script>
    ...
    Last updated
    <!-- #BeginDate format:Am1 -->October 13, 2022<!-- #EndDate -->.
    </p>
    </div>
    </html>
